 ...
 * @preserve
*/
!function(a){if("function"==typeof define&&define.amd)define(["jquery","src/assets/plugins/gridstack/lodash"],a);else if("undefined"!=typeof exports){try{jQuery=require("jquery")}catch(a){}try{_=require("src/assets/plugins/gridstack/lodash")}catch(a){}a(jQuery,_)}else a(jQuery,_)}(function(a, b){
